...
class RPC_HTTP_Response
{
	 ...
	 */
	public function setCookie( RPC_HTTP_Cookie $cookie )
	{
		if( headers_sent( $file, $line ) )
		{
		...
		if( ! $cookie->getName() )
		{
			throw new LogicException( 'Each cookie should have a name' );
		}
	 ...
	 *              accepted it)
	 */
	public function unsetCookie( RPC_HTTP_Cookie $cookie )
	{
		if( headers_sent() )
		{
