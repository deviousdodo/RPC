 ...
 * @package Controller
 */
class RPC_Controller_Router_Rewrite implements RPC_Controller_Router
{
	 ...
	 */
	public function setRequest( RPC_HTTP_Request $request ) /* {{{ */
	{
	...
	{
		return $this->_rpc_request === null ? RPC_HTTP_Request::getInstance() : $this->_rpc_request;
	}
	/* }}} */

	public function setResponse( RPC_HTTP_Response $response ) /* {{{ */
	{
