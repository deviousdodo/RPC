...
class RPC_Db
{
	...
	public static function factory( $connection = '' )
	{
		...
		*/
		...
		$tmp = 'RPC_Db_Adapter_' . $info['adapter'];
	...
	public static function addConnection( $name, $info )
	{
		if( ! is_array( $info ) )
		{
			throw new InvalidArgumentException( '$info should be an array or an array' );
		}
		
		if( empty( $name ) )
		{
			throw new UnexpectedValueException( 'The configuration array should have a database name set' );
		}
		elseif( empty( $info['database'] ) )
		{
			throw new UnexpectedValueException( 'The configuration array should have a database adapter set' );
		}
	...
	public static function setDefaultConnection( $name )
	{
		...
		{
			throw new UnexpectedValueException( 'Connection not loaded' );
		}
